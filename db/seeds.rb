...
2000.times do
  CommentUpdate.create(comment_id: Faker::Number.between(0, 999), update_date: Faker::Date.between_except(1.year.ago, 1.year.from_now, Date.today), update_type: "Phone", current_update: Faker::Lorem.characters(30), employee_name: Faker::Name.first_name)
end